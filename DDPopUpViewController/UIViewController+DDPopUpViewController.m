...
{
    [self.popUpWindow.rootViewController viewWillDisappear:YES];
    ...
    if (animationType != DDPopUpAnimationTypeNone) {
        __block typeof(self) weakSelf = self;
        [UIView animateWithDuration:animationDuration animations:^(){
            ...
            [weakSelf.popUpWindow.rootViewController viewDidDisappear:YES];
        ...
        [self.popUpWindow.rootViewController viewDidDisappear:YES];
        containerVC.presentingPopupController = nil;
        self.popUpWindow = nil;
        self.popUpViewController.popUpParentViewController = nil;
        self.popUpViewController = nil;
        [self.previosKeyWindow makeKeyWindow];
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:DDPopUpViewControllerDissmissNotification object:nil];
}
...
- (void)showPopUpViewController:(UIViewController *)popUpViewController  animationType:(DDPopUpAnimationType)animationType dismissWhenTouchBackground:(BOOL)dismissWhenTouchBackground
{
    ...
    */
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        win.windowLevel = UIWindowLevelStatusBar/2.0f;
    }
    else{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dismissPopUpViewWithoutAnimation) name:DDPopUpViewControllerDissmissNotification object:nil];
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.presentingPopupController.popUpViewController viewWillAppear:animated];
}

- (void)viewDidAppear:(BOOL)animated
{
    [super viewDidAppear:animated];
    [self.presentingPopupController.popUpViewController viewDidAppear:animated];
}

- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    [self.presentingPopupController.popUpViewController viewWillDisappear:animated];
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    [self.presentingPopupController.popUpViewController viewDidDisappear:animated];
}
